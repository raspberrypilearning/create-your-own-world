...
![තිර රුව(screenshot)](images/coin.png) \--- /task \---

\--- task \--- Add code to your `coin` sprite so that it only appears in room 1. ![තිර රුව(screenshot)](images/coin.png)
