...
Füge diesen Code zur Figur des `Spielers` hinzu:
...
Add more code to your `player` sprite so it can move down and to the right as well. Verwende den bereits geschriebenen Code als Hilfe.
