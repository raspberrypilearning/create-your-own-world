...
\--- task \--- Dodaj nową zmienną `monety`{:class="block3variables"} do swojego projektu.
...
![zrzut ekranu](images/coin.png)

\--- /task \---

\--- task \---

\--- task \--- Dodaj kod do swojego duszka `moneta`, aby pojawiał się tylko w pokoju 1.
...
Test your game. Zebranie monety powinno zmienić wartość zmiennej `monety` na `1`{:class="block3variables"}.
