...
You can now continue creating your own world! Aqui estão algumas ideias:
...
![captura de ecrã](images/north-south-rooms.png)

![captura de ecrã](images/number-grid.png)
