...
\--- task \--- A sign isn't much good if it doesn't say anything! Aggiungi del codice per far visualizzare un messaggio se lo sprite `cartello di benvenuto` sta toccando lo sprite `giocatore`:
